...
uint8_t receiver_address = ADDRESS_BALLOON_2;
...
void setInterruptPinAlba() {
  //Set pin PD2 as input
  DDRD &= ~(1 << DDD2);
}
...
void initExtIntAlba() {
  ...
  //Enable external interrupt on pin INT0 (datasheet p. 72) - 
  EIMSK |= (1 << INT0);
  //SREG should be set by the sei() function
