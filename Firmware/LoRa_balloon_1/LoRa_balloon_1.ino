...
const unsigned int delayTime = 31000;
...
int ADDRESS = 1;
int ADDRESS_RECEIVER_BALLOON = 2;
int ADDRESS_RECEIVER_GROUND = 8;
...
const char GPS_Request_string[] = "$PUBX,00*33\r\n";
...
void setup()
{
  ...
  e = sx1272.setChannel(0xD90136); //Frequency corrected value
  #if (debug > 1)
...
void loop(void) {
  ...
  String string = "B1: " + String(latitude,6) + ", " + String(langtitude,6) + ", " + String(height,1) + ", " + String(sats);
